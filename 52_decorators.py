...
"""
Practical use case
One common use of decorators is to add logging to a function. For example, you could use a decorator to log the arguments 
...
def my_decorator(func):
    def decorator_matter(*args,**kwargs):
        print("This is my decorator.")
        func(*args,**kwargs)
        print("This is output of my func")
        print("End of decorator.")
    return decorator_matter
...
without modifying their source code. They are a great tool for separating concerns, reducing code duplication, and making 
